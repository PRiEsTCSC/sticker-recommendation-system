...
use uuid::Uuid;
use crate::{configs::env_load::load_database_url, structs::database_structs::{Admin, DatabaseConnection, ManagementRequest, RegisterRequest, Session, User}};
...
impl DatabaseConnection {
    ...
    pub async fn save_interaction(
        ...
        sqlx::query(
            "INSERT INTO interactions (id, user_id, admin_id, input_text, detected_emotion, sticker_url, created_at) VALUES ($1, $2, $3, $4, $5, $6)",
        )
        .bind(Uuid::new_v4())
        .bind(user_id)
        .bind(input_text)
